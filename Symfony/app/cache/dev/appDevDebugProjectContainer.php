...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'AmineForumBundle', 'C:\\wamp\\www\\Symfony\\app/Resources/AmineForumBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'AmineForumBundle', 'C:\\wamp\\www\\Symfony\\src\\Amine\\ForumBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_0ce0b6cd24d9278792e8449ccd78d8db');
        ...
        $d = new \Symfony\Bridge\Doctrine\Mapping\Driver\YamlDriver(array(0 => 'C:\\wamp\\www\\Symfony\\src\\Projet\\CoursBundle\\Resources\\config\\doctrine'));
        $d->setNamespacePrefixes(array('C:\\wamp\\www\\Symfony\\src\\Projet\\CoursBundle\\Resources\\config\\doctrine' => 'Projet\\CoursBundle\\Entity'));
        $d->setGlobalBasename('mapping');

        $e = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $e->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(new \Symfony\Bridge\Doctrine\Annotations\IndexedReader($this->get('annotation_reader')), array(0 => 'C:\\wamp\\www\\Symfony\\src\\Amine\\ForumBundle\\Entity')), 'Amine\\ForumBundle\\Entity');
        $e->addDriver($d, 'Projet\\CoursBundle\\Entity');

        $f = new \Doctrine\ORM\Configuration();
        $f->setEntityNamespaces(array('AmineForumBundle' => 'Amine\\ForumBundle\\Entity', 'ProjetCoursBundle' => 'Projet\\CoursBundle\\Entity'));
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => 'C:\\wamp\\www\\Symfony\\vendor\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))), NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'AmineForumBundle' => 'Amine\\ForumBundle\\AmineForumBundle',
