...
use Projet\UserBundle\Form\PromotionType;
...
class PromotionController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ProjetUserBundle:Promotion')->findAll();

        return $this->render('ProjetUserBundle:Promotion:index.html.twig', array(
            'entities' => $entities
        ));
    }
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ProjetUserBundle:Promotion')->find($id);
        ...
        return $this->render('ProjetUserBundle:Promotion:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function newAction()
    {
        ...
        return $this->render('ProjetUserBundle:Promotion:new.html.twig', array(
            'entity' => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('ProjetUserBundle:Promotion:edit.html.twig', array(
            'entity'      => $entity,
