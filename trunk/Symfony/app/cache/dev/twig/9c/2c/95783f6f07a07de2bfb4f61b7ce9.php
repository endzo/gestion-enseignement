...
/* AmineForumBundle:Comment:edit.html.twig */
class __TwigTemplate_9c2c95783f6f07a07de2bfb4f61b7ce9 extends Twig_Template
{
...
<form action=\"";
        // line 3
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("comment_update", array("id" => $this->getAttribute($this->getContext($context, "entity"), "id"))), "html", null, true);
        echo "\" method=\"post\" ";
...
";
    ...
    {
        return "AmineForumBundle:Comment:edit.html.twig";
    }
