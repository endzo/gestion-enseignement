...
/* ProjetCoursBundle:Enseignement:index.html.twig */
class __TwigTemplate_63e637c75f00fedc044fa0cbedda8649 extends Twig_Template
{
            ...
            <td>
                <ul>
                    <li>
                        <a href=\"";
            // line 33
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("enseignement_show", array("id" => $this->getAttribute($this->getContext($context, "entity"), "id"))), "html", null, true);
            echo "\">show</a>
                    </li>
                    <li>
                        <a href=\"";
...
";
    ...
    {
        return "ProjetCoursBundle:Enseignement:index.html.twig";
    }
